    ...
    <section className="page-panel" style={{ animation: "fadeInSlideUp 0.3s var(--ease-out-quart) forwards" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: "20px" }}>
        ...
        <button 
          ...
          className="btn btn-secondary"
          style={{ padding: "8px 16px", borderRadius: "6px", border: "1px solid var(--border)", background: "var(--surface)", opacity: conversions.length < limit ? 0.5 : 1, cursor: conversions.length < limit ? "default" : "pointer" }}
        >
          Next
        </button>
      </div>
